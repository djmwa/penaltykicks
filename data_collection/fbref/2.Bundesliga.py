...
def scrape_and_save_fbref_table(url):
    ...
    output_dir = f'2bundesliga_tables_{yr}'
...
# Year range: 2. Bundesliga history from 2003 to 2025
start_years = list(range(2003, 2025))
seasons = [str(yr) + '-' + str(yr + 1) for yr in start_years]

# Season-specific stats page
base_url = 'https://fbref.com/en/comps/33/{0}/{0}-2-Bundesliga-Stats'
