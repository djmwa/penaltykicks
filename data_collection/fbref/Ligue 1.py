...
def scrape_and_save_fbref_table(url):
    ...
    output_dir = f'ligue_1_tables_{yr}'
...
# Year range: Ligue 1 history from 1995 to 2025
start_years = list(range(1995, 2025))
seasons = [str(yr) + '-' + str(yr + 1) for yr in start_years]

# Season-specific stats page
base_url = 'https://fbref.com/en/comps/13/{0}/{0}-Ligue-1-Stats'
