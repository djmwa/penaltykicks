...
# Year range: MLS history from inception to 2025
start_years = list(range(1996, 2026))
seasons = [str(yr) for yr in start_years]

# Season-specific stats page
base_url = 'https://fbref.com/en/comps/22/{0}/{0}-Major-League-Soccer-Stats'
