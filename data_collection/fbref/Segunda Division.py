...
def scrape_and_save_fbref_table(url):
    ...
    output_dir = f'segunda_division_tables_{yr}'
...
# Year range: Segunda Division history from 2001 to 2025
start_years = list(range(2001, 2025))
seasons = [str(yr) + '-' + str(yr + 1) for yr in start_years]

# Season-specific stats page
base_url = 'https://fbref.com/en/comps/17/{0}/{0}-Segunda-Division-Stats'
