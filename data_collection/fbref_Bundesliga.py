...
def scrape_and_save_fbref_table(url):
    ...
    output_dir = f'bundesliga_tables_{yr}'
...
# Year range: Bundesliga history from 1988 to 2025
start_years = list(range(1988, 2025))
seasons = [str(yr) + '-' + str(yr + 1) for yr in start_years]

# Season-specific stats page
base_url = 'https://fbref.com/en/comps/20/{0}/{0}-Bundesliga-Stats'
