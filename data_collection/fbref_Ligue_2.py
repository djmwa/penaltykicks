...
def scrape_and_save_fbref_table(url):
    ...
    output_dir = f'ligue_2_tables_{yr}'
...
# Year range: Ligue 2 history from 2009 to 2025
start_years = list(range(2009, 2025))
seasons = [str(yr) + '-' + str(yr + 1) for yr in start_years]

# Season-specific stats page
base_url = 'https://fbref.com/en/comps/60/{0}/{0}-Ligue-2-Stats'
